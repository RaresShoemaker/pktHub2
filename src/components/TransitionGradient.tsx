    ...
    return (
        <>
            ...
            <div
                ...
                className='absolute w-screen flex-shrink-0 md:bottom-[-215px] md:h-[429px] h-[190px] bottom-[100px]'
                style={{
                    ...baseStyle,
            ...
            <div
                ...
                className='absolute w-screen flex-shrink-0 md:bottom-[-315px] md:h-[429px] h-[190px] bottom-[50px]'
                style={{
                    ...baseStyle,
            ...
            <div
                ...
                className='absolute w-screen flex-shrink-0 md:bottom-[-315px] md:h-[429px] h-[190px] bottom-[0px]'
                style={{
                    ...baseStyle,
